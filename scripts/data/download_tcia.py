...
# Add src to path to import oncolearn modules
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "src"))

from oncolearn.data.tcia import TCIACohortBuilder
...
def download_cohorts(
    ...
    for cohort_code in cohorts:
        ...
        success = download_cohort(cohort_upper, output_dir, download_images, verbose)
...
def download_all(
    ...
    return download_cohorts(available_cohorts, output_dir, download_images, verbose)
