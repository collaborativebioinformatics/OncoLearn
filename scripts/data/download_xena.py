...
def download_cohort(
    ...
    try:
        ...
        if category:
            ...
            cohort.download(output_dir=output_dir, download_all=True)
...
def download_cohorts(
    ...
    for cohort_code in cohorts:
        ...
        success = download_cohort(cohort_upper, output_dir, category, verbose)
...
def download_all(
    ...
    return download_cohorts(available_cohorts, output_dir, category, verbose)
